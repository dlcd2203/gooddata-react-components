...
const colorMapping = [
    {
        predicate: headerItem =>
            ...
            headerItem.attributeHeader.uri ===
                "/gdc/md/xms7ga4tf3g3nzucd8380o2bev8oeknp/obj/9461/elements?id=10456587", // find attribute item by uri
        color: {
            type: "guid",
            value: "03",
        },
    ...
    {
        predicate: headerItem => headerItem.attributeHeader && headerItem.attributeHeader.name === "Hawaii", // find attribute item by Name
        color: {
            type: "rgb",
